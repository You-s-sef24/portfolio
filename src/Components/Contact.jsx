...
export default function Contact() {
  ...
  return (
    <div
      id="contact"
      className="min-h-screen w-full bg-gray-900 text-white p-6 flex flex-col justify-center"
    >
      ...
      <div className="w-full max-w-4xl mx-auto">
        <div className="rounded shadow-sm bg-slate-800/40 border border-slate-800 overflow-hidden w-full">
